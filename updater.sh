...
find . -maxdepth 1 ! \( -name "settings.zip" -o -name "database.zip" -o -name "config.json" -o -name "latest_release.zip" \) -exec rm -rf {} \;
...
cd vortexusyoshino && mv * .[^.]* /home/container/
...
rm -rf /home/container/vortexusyoshino
...
unzip /home/container/database.zip -d /home/container/
...
rm /home/container/database.zip
# E fim! kkkk